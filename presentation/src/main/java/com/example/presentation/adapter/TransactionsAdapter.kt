...
import com.example.presentation.adapter.holder.TransactionViewHolder
...
class TransactionsAdapter (private var transactionsList: ArrayList<TransactionUIModel>) : RecyclerView.Adapter<TransactionViewHolder>() {
